...
#
# Reports classification AND selection against n, and the paired per-replicate differences that the shared-data design permits. The paired column
# `vs_skewt` on setting C3 is the quantity quoted in Appendix G.2: 0.061 (0.002) at n = 80, decreasing monotonically to 5.6e-5 (7.7e-5) at n = 800.
#
