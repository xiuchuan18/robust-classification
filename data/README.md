...
|---|---|---|
| Prostate cancer (`p = 6033`) | 5.1 | `data(prostate, package = "spls")` — ships with the CRAN package |
| Pima Indians diabetes | 5.2 | `data("PimaIndiansDiabetes", package = "mlbench")` — ships with the CRAN package |
